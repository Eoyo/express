...
!function(n) {
    function e(n, e) {
        ...
        var o = C.waitSeconds;
        return o && n instanceof Array && (D && clearTimeout(D),
        D = setTimeout(t, 1e3 * o)),
        _(n, e)
    }
    function t() {
        function n(a, u) {
        ...
        if (e.length || t.length)
            throw new Error("[MODULE_TIMEOUT]Hang( " + (e.join(", ") || "none") + " ) Miss( " + (t.join(", ") || "none") + " )")
    }
    function r(n) {
        $(H, function(e) {
    ...
    function m(e, t, r, i) {
        function o() {
            if (!a) {
                ...
                r && (a = 1,
                "function" == typeof t && t.apply(n, p(e, P)))
            }
        }
        if ("string" == typeof e) {
            if (d(e),
    ...
    function U(n) {
        Y = n,
        ee ? ne.insertBefore(n, ee) : ne.appendChild(n),
        Y = null
    }
    function O(n) {
        return new RegExp("^" + n + "(/|$)")
    ...
    ,
    k();
    var J, K, V, W, X, Y, Z, ne = document.getElementsByTagName("head")[0], ee = document.getElementsByTagName("base")[0];
    ee && (ne = ee.parentNode),
    define || (define = i,
    require || (require = e),
    esl = e)
